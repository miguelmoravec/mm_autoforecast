...
dm = size(ano_2014);
for i=1:10;
  tmp = squeeze(mean(ano_2014(i:i+2,:,:)));
  ano_2014_3mm(i,:,:) = tmp;
end
...
caxis([cv1 cv2]);
m_text(40,-75,'Jul','BackgroundColor',[0.95 0.95 0.95])
...
set(gca,'DataAspectRatio',[ratio_x 1 1])
caxis([cv1 cv2]);
m_text(40,-75,'Aug','BackgroundColor',[0.95 0.95 0.95])
...
set(gca,'DataAspectRatio',[ratio_x 1 1])
caxis([cv1 cv2]);
m_text(40,-75,'Sep','BackgroundColor',[0.95 0.95 0.95])
...
set(gca,'DataAspectRatio',[ratio_x 1 1])
caxis([cv1 cv2]);
m_text(40,-75,'Oct','BackgroundColor',[0.95 0.95 0.95])
...
set(gca,'DataAspectRatio',[ratio_x 1 1])
caxis([cv1 cv2]);
m_text(40,-75,'Nov','BackgroundColor',[0.95 0.95 0.95])
...
set(gca,'DataAspectRatio',[ratio_x 1 1])
caxis([cv1 cv2]);
m_text(40,-75,'Dec','BackgroundColor',[0.95 0.95 0.95])
